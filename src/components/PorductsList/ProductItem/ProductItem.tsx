...
const ProductItem: FC<IProductItem> = ({ product: { description, id, price, title, imageUrl }, stubProductImageNode }) => {
    ...
    <div className='bg-white shadow-lg rounded-lg p-6 w-72'>
      {
        imageUrl ?
          ...
          stubImage && <GatsbyImage image={stubImage} objectFit='cover' alt='productStub' className='w-full h-64 object-cover rounded-lg shadow-md' />
      }
